...
const servicesTree = [
  {
    ...
    promo: {
      ...
      price: '',
      description: 'Оценим достаточность объектов, пригодность для экспертизы, сформулируем вероятный (предварительный) вывод. Услуга выездной консультации: приедем и проконсультируем у Вас в офисе.',
...
const enrichTree = (nodes, parentSlug = null, level = 0, parentPath = '') =>
  nodes.map((node) => {
    ...
    const entry = { ...node, children: enrichedChildren, parentSlug, level, path }
